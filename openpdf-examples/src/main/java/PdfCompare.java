 ...
 *
 * 独立的 OpenPDF API 演示工具，逐行展示 OpenPDF 与 pdf-cj 两套 API 的差异。
 * （较新的逐模块对照见 RunAllSections + S01–S23。）
 *
 * ════ 主要 API 差异一览 ════════════════════════════════════════════════════
 ...
 * ═══════════════════════════════════════════════════════════════════════════
 *
 * 生成文件（输出到 openpdf-examples/output/）:
...
public class PdfCompare {
    ...
    static final String IMG_DIR   = "images/";   // 相对于 openpdf-examples/ 的路径
    static final String OUT_DIR   = "output/";                  // openpdf-examples/output/
