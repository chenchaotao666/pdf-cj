#!/bin/bash
# build.sh — 自动检测 HiTLS 库位置并生成 cjpm.toml，然后构建 pdf-cj 库
#
# 用法：
#   ./build.sh                         # 检测 + 构建
...
[dependencies]
# 引用 chaoling83/zlib4cj.git（作者修改版，官方 Cangjie-TPC/zlib4cj 有编译问题）
zlib4cj = { git = "https://gitcode.com/chaoling83/zlib4cj.git" }
